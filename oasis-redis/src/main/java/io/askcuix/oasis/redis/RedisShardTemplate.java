...
import io.askcuix.oasis.redis.pool.shard.RedisShardPool;
import io.askcuix.oasis.redis.util.RedisUtil;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import io.askcuix.oasis.redis.pool.shard.RedisShardConnectionPool;
...
public class RedisShardTemplate {
    private static final Logger logger = LoggerFactory.getLogger(RedisShardTemplate.class);
     ...
     */
    public <T> T executeWrite(String key, RedisExecution.RedisReturnAction<T> redisAction) throws JedisException {
        Jedis jedis = null;
     ...
     */
    public void executeWrite(String key, RedisExecution.RedisAction redisAction) throws JedisException {
        Jedis jedis = null;
        RedisShardPool redisPool = null;
        boolean broken = false;
     ...
     */
    public <T> T executeRead(String key, RedisExecution.RedisReturnAction<T> redisAction) throws JedisException {
        Jedis jedis = null;
        RedisShardPool redisPool = null;
        boolean broken = false;
     ...
     */
    public List<Object> doPiplineAndReturn(String key, RedisExecution.PipelineAction pipelineAction) throws JedisException {
        Jedis jedis = null;
        RedisShardPool redisPool = null;
        boolean broken = false;
     ...
     */
    public void doPipline(String key, RedisExecution.PipelineAction pipelineAction) throws JedisException {
        Jedis jedis = null;
        RedisShardPool redisPool = null;
        boolean broken = false;
    ...
    public Boolean del(final String key) {
        return executeWrite(key, new RedisExecution.RedisReturnAction<Boolean>() {
    ...
    public Boolean exists(final String key) {
        return executeRead(key, new RedisExecution.RedisReturnAction<Boolean>() {
    ...
    public String get(final String key) {
        return executeRead(key, new RedisExecution.RedisReturnAction<String>() {
    ...
    public void set(final String key, final String value) {
        executeWrite(key, new RedisExecution.RedisAction() {
    ...
    public String getSet(final String key, final String value) {
        return executeWrite(key, new RedisExecution.RedisReturnAction<String>() {
    ...
    public Long incr(final String key) {
        return executeWrite(key, new RedisExecution.RedisReturnAction<Long>() {
            @Override
    ...
    public Double incrByFloat(final String key, final double increment) {
        return executeWrite(key, new RedisExecution.RedisReturnAction<Double>() {
            @Override
    ...
    public List<String> hmget(final String key, final String... fields) {
        return executeRead(key, new RedisExecution.RedisReturnAction<List<String>>() {
            @Override
    ...
    public Map<String, String> hgetAll(final String key) {
        return executeRead(key, new RedisExecution.RedisReturnAction<Map<String, String>>() {
            @Override
    ...
    public Set<String> hkeys(final String key) {
        return executeRead(key, new RedisExecution.RedisReturnAction<Set<String>>() {
            @Override
    ...
    public Long hlen(final String key) {
        return executeRead(key, new RedisExecution.RedisReturnAction<Long>() {
            @Override
            public Long execute(Jedis jedis) {
    ...
    public Double zscore(final String key, final String member) {
        return executeRead(key, new RedisExecution.RedisReturnAction<Double>() {
    ...
    public Set<Tuple> zrangeWithScores(final String key, final int start, final int end) {
        return executeRead(key, new RedisExecution.RedisReturnAction<Set<Tuple>>() {
